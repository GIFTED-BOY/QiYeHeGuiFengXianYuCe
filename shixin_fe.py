...
def fe():
    ...
    label_df1 = pd.concat([label_df11, label_df12], axis=0, ignore_index=True).drop_duplicates('企业名称')
    label_df1['label1'] = 1
    ...
    label_df2 = pd.concat([label_df21, label_df22], axis=0, ignore_index=True).drop_duplicates('企业名称')
    label_df2['label2'] = 1
    ...
    labels1 = df['label1'].values
    train_names = df['企业名称']
    del df['企业名称'], df['label1'], df['label2']
    ...
    return df, train_names, labels1, test_df, test_names
